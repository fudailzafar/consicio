...
export function SummaryViewer({ summary }: { summary: string }) {
  ...
  const sections = summary
    ...
    .map(parseSection);
  return (
    <Card className="relative px-2 h-[500px] sm:h-[600px] lg:h-[700px] w-full xl:w-[600px] overflow-hidden bg-linear-to-br from-background via-background/95 to-rose-500/5 backdrop-blur shadow-2xl rounded-3xl border border-rose-500/10">
